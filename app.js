const tl = gsap.timeline({
    dafaults: {duration: 0.75, ease: "power3.out"}
})

tl.fromTo ('.hero-img', {scale: 1.3, borderRadius: "0rem"}, {scale: 1, borderRadius: "2rem", delay:0.35, duration: 2.5, ease: "elastic.out(1.5, 0.5)"})
